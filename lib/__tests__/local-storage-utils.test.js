...
describe('local-storage-utils#appendToEntry', () => {
  ...
  it('should replace a value on the entry', function() {
...
describe('local-storage-utils#retrieveEntry', () => {
  ...
  it('should return an entry because the existing entry has not expired', function() {
    localStorageUtils.persistEntry('testkey1', { testvalue: 'test value 1' });
  ...
  it('should return null because the existing entry has expired', function() {
    localStorageUtils.persistEntry('testkey1', { testvalue: 'test value 1' });
...
describe('local-storage-utils#persistEntry', () => {
  ...
  it('should set new entry', function() {
    localStorageUtils.persistEntry('testkey1', { testvalue: 'test value 1' });
  ...
  it('should not set a subsequent entry because the previous entry with the same key has not yet expired.', function() {
    localStorageUtils.persistEntry('testkey1', { testvalue: 'test value 1' });
  ...
  it('should persist the first entry and then overwrite it with the second', function() {
    localStorageUtils.persistEntry('testkey1', { testvalue: 'test value 1' });
    localStorageUtils.appendToEntry('testkey1', 'timestamp', 1578877204000);
...
describe('local-storage-utils#setStorageObject', () => {
  ...
  it('it is implicit in these tests', function() {});
});
